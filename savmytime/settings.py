"""
Django settings for savmytime project.
...
SECRET_KEY = '$^)w%fjb6+zy@xihiu70w-*-48!x10*#u^91ah^llcu5mo^nqi'
...
WSGI_APPLICATION = 'savmytime.wsgi.application'
